...
export const addFile = action({
    args:{
        ...
        const subscription = await ctx.runQuery(
            internal.system.subsciptions.getByOrganizationId,{
        ...
        const { created , entryId} = await rag.add(ctx, {
            // SUPER IMPORTANT : What search space to add to this to, you cannot search ascross namespaces,
            ...
            // To avoid re-inserting if the file content has changed
