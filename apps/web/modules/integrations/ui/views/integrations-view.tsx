...
export const IntgrationsView = () => {
    ...
    const handleCopy = async() => {
        try {
            ...
            toast.error("Failed to copy yo clipboard");
        }
    }
                    ...
                    <div className="mt-8 space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <Input 
                                ...
                                className="flex-1 bg-background font-mon text-sm"
                            />
                            <Button
                                className="gap-2"
                                onClick={handleCopy}
...
export const IntergationsDialog = ({
    open,
    onOpenChange,
    snippet,
}: {
   ...
   snippet : string, 
    ...
    return(
        <Dialog onOpenChange={onOpenChange} open={open}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Intergate with your Website</DialogTitle>
                    <DialogDescription>
                        Follow these steps to add the chatbox tto your website
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-6">
                    ...
                    <div className="group relative">
                        <pre className="max-h-[300px] overflow-x-auto overflow-y-auto whitespace-pre-wrap break=all rounded-mmd bg-foreground p-2 font-mono text-secondary text-sm">
                            {snippet}
                        </pre>
                        <Button
                            className="absolute top-2.5 right-4 opacity-0 transition-opacity group-hover:opacity-100"
                            onClick={handleCopy}
                            size="icon"
                            variant="secondary"
                        >
