                            ...
                            return(
                                <Link 
                                    ...
                                    className={cn(
                                        ...
                                        pathname === `/dashboard/conversations/${conversation._id}` && 
                                ...
                                >
                                    <div className={cn(
                                        ...
                                        pathname === `/dashboard/conversations/${conversation._id}` && "opacity-100"
                                    )}/>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-1 flex items-center justify-between gap-2">
                                            ...
                                            <ConversationStatusIcon className="" status={conversation.status}/>
                                        </div>
                                    </div>
                                </Link>
                            )
