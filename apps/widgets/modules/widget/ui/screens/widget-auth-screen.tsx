...
export const WidgetAuthScreen = () => {
    ...
    const onSubmit = async (data: z.infer<typeof formSchema>) => {
        if (!organizationId) {
            console.error("Submission blocked: Organization ID is missing.");
            return;
        }
        ...
        <>
            ...
            <Form {...form}>
                ...
                >
                    ...
                    />
                    <Button
                        // CHANGED LINE: Also disable the button if organizationId is missing
                        disabled={!organizationId || form.formState.isSubmitting}
                        size="lg"
                        type="submit"
                    >
                        Continue
